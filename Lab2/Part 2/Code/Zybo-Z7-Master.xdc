...
##Switches for enable and select line
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { en }];  #IO_L19N_T3_VREF_35 Sch=sw[0] (Enable)
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { sel }]; #IO_L24P_T3_34 Sch=sw[1] (Select line)

##Buttons for reset
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L12N_T1_MRCC_35 Sch=btn[0] (Reset)
