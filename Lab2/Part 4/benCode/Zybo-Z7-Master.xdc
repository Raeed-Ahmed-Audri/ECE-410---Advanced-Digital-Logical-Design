...
##Clock signal
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { clock }]; #IO_L12P_T1_MRCC_35 Sch=clock
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clock }];

##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { motion_sensor }]; #IO_L10P_T1_34 Sch=motion_sensor  			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { fully_closed }]; #IO_L10N_T1_34 Sch=fully_closed		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { fully_open }]; #IO_L1P_T0_34 Sch=fully_open              
...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { force_open }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { motor[1] }]; #IO_L23P_T3_35 Sch=motor[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { motor[0] }]; #IO_L23N_T3_35 Sch=motor[1]
