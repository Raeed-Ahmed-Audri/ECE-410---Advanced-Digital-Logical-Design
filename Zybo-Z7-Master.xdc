...
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { data_in[4] }]; #IO_L8P_T1_34 Sch=jc_p[3]              
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { data_in[5] }]; #IO_L8N_T1_34 Sch=jc_n[3]              
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { data_in[6] }]; #IO_L2P_T0_34 Sch=jc_p[4]              
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { data_in[7] }]; #IO_L2N_T0_34 Sch=jc_n[4]              
...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { segments[0] }]; #IO_L6P_T0_34 Sch=jd_p[2] yes                
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { display_select }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]            
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { data_out[4] }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]            
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33     } [get_ports { data_out[5] }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]            
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33     } [get_ports { data_out[6] }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]            
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { data_out[7] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]                
